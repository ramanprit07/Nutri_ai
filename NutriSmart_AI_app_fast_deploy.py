...
def train_models(df):
    ...
    # Train Logistic Regression directly for faster Streamlit deployment.
    # The previous version used GridSearchCV with 9 C values and 5-fold
    # cross-validation (45 model fits). A fixed C=1.0 is used here so the
    # deployed application starts much faster.
    model = logistic_pipeline.set_params(model__C=1.0)
